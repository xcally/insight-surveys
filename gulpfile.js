...
gulp.task("watch", function () {
  return gulp.watch(
    ["i18n/**/*.json", "./src/**/*.html", "./styles/*.*css", "src/**/*.js"],
    ["default"]
  );
});
...
function buildModuleStream(destPrefix, moduleName) {
  ...
  var bootstrapTemplates = buildTemplates(
    tmpDir + "/templates/bootstrap/",
    moduleName,
    "dist",
    destPrefix + "-bootstrap"
  );
  var materialTemplates = buildTemplates(
    tmpDir + "/templates/material/",
    moduleName,
    "dist",
    destPrefix + "-material"
  );
